...
def tests_to_run(forwarder):
    import BasicTest, RandomDropTest, SackRandomDropTest
    import RandomDuplicationTest, SackRandomDuplicationTest
    import RandomShuffleTest, SackRandomShuffleTest
